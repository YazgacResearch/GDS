#ifndef OPENSMART_PARALLEL_SHIELDS_H
#define OPENSMART_PARALLEL_SHIELDS_H

#include <avr/io.h>


#if defined(__AVR_ATmega328P__)       //regular UNO shield on UNO
  ...
  // is a destination variable; this isn't a function and doesn't
  // return a value in the conventional sense.
  #define read_8()	( ((PINH & B00011000) << 3) | ((PINB & B10110000) >> 2) | ((PING & B00100000) >> 1) | ((PINH & B01100000) >> 5) )
  #define setWriteDir() { DDRH |=  B01111000; DDRB |=  B10110000; DDRG |=  B00100000; }
  #define setReadDir()  { DDRH &= ~B01111000; DDRB &= ~B10110000; DDRG &= ~B00100000; }
...
#endif // OPENSMART_PARALLEL_SHIELDS_H