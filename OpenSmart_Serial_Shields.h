#ifndef OPENSMART_SERIAL_SHIELDS_H
#define OPENSMART_SERIAL_SHIELDS_H
...
#include <SPI.h>
  ...
  #define RESET_PIN  0
	...
	#define SD_PIN     4
	#define SPCRVAL ( USART_CLK2X_bm | USART_RXEN_bm | USART_TXEN_bm )
	#define SETDDR  { PORTCFG.VPCTRLB=PORTCFG_VP13MAP_PORTD_gc | PORTCFG_VP02MAP_PORTC_gc; \
										VPORT3.DIR |= (1<<0)|(1<<1)|(1<<3); \
										VPORT2.DIR |= 0x03; PIN_HIGH(SD_PORT, SD_PIN); \
										SD_PORT.DIR |= (1<<SD_PIN); \
									}
...
#endif OPENSMART_SERIAL_SHIELDS_H